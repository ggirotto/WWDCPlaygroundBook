...
public class Player:SKSpriteNode{
    ...
    private func addObjectToInventory(object:SKNode){
    ...
    public func sendMessagesToPlayer(messagesToSend:SKLabelNode){
